...
public class StatusService extends Service {
    ...
    private final String notificationChannelId = "PowerStatusChannel";
    private final int powerStatusNotificationId = 1;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        sosRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                String powerStatus = snapshot.getValue(String.class);
                Log.d("value_powerStatus", "Value is: " + powerStatus);
                if ("true".equals(powerStatus)) {
