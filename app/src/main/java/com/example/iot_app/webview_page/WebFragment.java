...
import com.example.iot_app.FanFragment;
...
public class WebFragment extends Fragment {
    ...
    private Button changeLampButton, changeAirButton, changeFanButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        changeFanButton = rootView.findViewById(R.id.change_fan);
        ...
        changeLampButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                changeFanButton.setVisibility(View.GONE);
            }
        });
        ...
        changeFanButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager fragmentManager = requireActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                FanFragment fragmentFan = new FanFragment();
                fragmentTransaction.replace(R.id.fragment_container, fragmentFan);
                fragmentTransaction.commit();
